...
FIXME:
   $ ./riemann -problem swater -initial hump -b0 -1 -bx -0.1 -da_grid_x 1000 -limiter minmod -ts_monitor binary:t.dat -ts_monitor_solution binary:q.dat
   $ ./plotsw.py -mx 1000 -c 0 -ylabel "h (height)" -ax -5.0 -bx 5.0 -bath0 -1 -bathx -0.1 t.dat q.dat
'''
